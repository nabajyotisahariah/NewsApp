...
const Home = ({navigation}: {navigation: any}) => {
  ...
  const loadData = () => {
    const defaultData1 = [
      ...
      {
        _name:'DY 365',
        _uri:'https://cdn.smartstream.video/smartstream-us/dy365/dy365/playlist.m3u8',
        _type:'live',
      _poster:'https://dy365.in/images/logo.png',
      },
      {
        _name:'Network 18',
        _uri:'https://nw18live.cdn.jio.com/bpk-tv/News18_Assam_North_East_NW18_MOB/output01/News18_Assam_North_East_NW18_MOB-audio_131636_eng=131600-video=699600.m3u8',
        _type:'live',
      _poster:'https://images.news18.com/assam/uploads/2020/11/desktop-assam-navlogo.png',
      },
      {
        _name:'Ads',
