  ...
  return (
    <View style={{display: flex, flexDirection: 'column'}}>
      ...
      <View style={SettingPageStyles.LinksSettings}>
        ...
        <Text
          onPress={() => Linking.openURL(constants.TERMS_AND_CON_LINK)}
          style={SettingPageStyles.SingleLink}>
          Terms and Conditions
        </Text>
        <Text
          onPress={() => Linking.openURL(constants.WEBSITE_LINK)}
          style={SettingPageStyles.SingleLink}>
          Our Website
        </Text>
        <Text
        ...
        <Text
          onPress={() => Linking.openURL(constants.FEEDBACK_LINK)}
          style={SettingPageStyles.SingleLink}>
          Feedback
        </Text>
      </View>
      ...
      <View style={SettingPageStyles.osNewsStyle}>
        <Text
          ...
          style={SettingPageStyles.osNewsStyleHeader}>
          About Developer
        </Text>
        <Text
          onPress={() => Linking.openURL('#')}
